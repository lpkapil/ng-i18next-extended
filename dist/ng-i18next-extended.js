/*!
 * ng-i18next-extended - Version 1.0.0 - 2023-09-27
 * Copyright (c) 2023 Kapil Yadav
 *
 * AngularJS provider, filter and directive for i18next
 *
...
var I18nTranslateService = /** @class */ (function () {
    ...
    I18nTranslateService.prototype.initializeI18next = function () {
        ...
        //Compatibility fix with i18next:v19.83 to use Promies instead EventEmitter
        i18next.init(i18next).then((v) => {
            self.$rootScope.$broadcast('i18nextLanguageChange', i18next.language);
        });
    };
